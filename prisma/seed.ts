...
async function main() {
  ...
  console.log("\n + 🏛️  Seeding exercise history");
  const history = await prisma.exerciseHistory.createMany({
    data: [
      {
      ...
      },
      {
        ...
        visitedAt: new Date(2023, 1, 3),
        userId: "clduelk2900003b6leubwp06d",
        activityResourceId: "AnimalTester2",
      },
      {
        completedAt: new Date(2023, 1, 4),
        visitedAt: new Date(2023, 1, 4),
        userId: "clduelk2900003b6leubwp06d",
        activityResourceId: "arraylist.vocabulary",
      },
      {
