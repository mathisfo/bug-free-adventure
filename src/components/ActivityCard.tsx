...
const ActivityCard = ({type, bg, boxColor, fillColor, fillColorDark}: {type:string, bg:string, boxColor:string, fillColor: string, fillColorDark: string}) => {
  ...
  <path fillRule="evenodd" d="M4.21 14.77a.75.75 0 01.02-1.06L8.168 10 4.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clipRule="evenodd" />
    ...
    return (
        <div className={`${theme == "dark" ? "bg-[#1c1f37]" : bg}  rounded-lg  text-white w-4/5 grid grid-cols-5`}>
            ...
            <div className={`${theme == "dark" ? "bg-[#2F3358]" : boxColor} col-start-4 col-span-2 row-span-2 rounded-lg h-full p-4`}><DonutChart size="110px" bg="white" fillColor={fillColor} fillColorDark={fillColorDark} /></div>
